package com.coacenms.courseservice.Controller;
...
public class Course_Controller
{
    ...
    public ResponseEntity<Optional<Course>> get_all_courses(@PathVariable("id") int course_id) throws courseNotFoundException, courseNotFoundException {
