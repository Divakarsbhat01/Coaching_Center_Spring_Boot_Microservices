package com.coacenms.teacherservice.Controller;
...
public class Teacher_Controller
{
    ...
    public ResponseEntity<Optional<Teacher>> get_all_teachers(@PathVariable("id") int teacher_id) throws teacherNotFoundException, teacherNotFoundException {
