package com.coacenms.studentservice.Controller;
...
public class Student_Controller
{
    ...
    public ResponseEntity<Optional<Student>> get_all_students(@PathVariable("id") int student_id) throws studentNotFoundException, studentNotFoundException {
